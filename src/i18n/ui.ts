...
export const UI_STRINGS = {
    ...
    'settings.textEditor': { en: 'Text Editor', fr: 'Éditeur de texte' },
    'settings.wordWrap': { en: 'Word Wrap', fr: 'Retour à la ligne' },
    'settings.wordWrapDesc': { en: 'Controls how lines should wrap.', fr: 'Contrôle le retour à la ligne automatique.' },
    'settings.minimap': { en: 'Minimap', fr: 'Mini-carte' },
    'settings.minimapDesc': { en: 'Shows a high-level overview of the code.', fr: "Affiche un aperçu global du code." },
    ...
    'settings.easyMode': { en: 'Easy Mode', fr: 'Mode simplifié' },
    'settings.easyModeDesc': { en: 'Simplifies the UI for non-developers by removing complex VS Code elements.', fr: "Simplifie l'interface pour les non-développeurs en retirant les éléments VS Code complexes." },
