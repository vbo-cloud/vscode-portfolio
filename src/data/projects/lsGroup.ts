...
export const lsGroup = {
    ...
    description: {
        ...
        fr: "Alternance de deux ans en développement VR/industriel chez LS Group, au sein de l'équipe XR Twin : reconstruction du système de navigation depuis zéro, développement du front-end multijoueur en binôme avec un coéquipier, et une réduction des temps de chargement pouvant aller jusqu'à 70%."
    },
    descriptionSections: [
        {
        ...
        },
        {
            ...
            text: {
                ...
                fr: `Un bug de Copier/Coller dans l'AppearanceComponent provenait en réalité d'une violation d'architecture : le composant récupérait les données de couleur via des types spécifiques à Unity plutôt que des valeurs brutes. Je l'ai découplé, puis j'ai trouvé le même problème sous-jacent dupliqué indépendamment — et cassé — dans le Copier/Coller de chaque autre composant. J'ai tout centralisé dans un système ClipBoard unique reposant sur deux méthodes : copier un Behavior, puis le coller sur le composant correspondant, réglant le Copier/Coller de tous les composants d'un coup plutôt que de les corriger un par un.`
            }
        },
        {
        ...
        },
        {
            ...
            text: {
                ...
                fr: `J'ai aussi débogué la simulation ergonomique VR d'XR Twin (User Ergo) après qu'une mise à jour majeure du système l'a cassée : le calibrage des capteurs de mouvement s'était désynchronisé de la nouvelle architecture, la locomotion par téléportation VR ne fonctionnait plus, et le composant Ergo Inspector avait perdu sa liaison avec la bonne entité, affichant des données incorrectes ou manquantes. Tester cela impliquait de mettre le casque et les trackers moi-même pour reproduire et valider chaque correctif.`
            },
        ...
        },
        {
            ...
            text: {
                ...
                fr: `La deuxième année s'est concentrée sur une réécriture complète de la navigation d'XR Twin, une tâche qui m'a été confiée individuellement au sein de l'équipe : le système existant était rigide, imprécis sur les petites pièces industrielles, et incohérent selon les contextes. J'ai étudié le fonctionnement interne de la navigation d'Unity pour comprendre son modèle caméra-cible, puis conçu un système abstrait sur l'Input System d'Unity où des classes "Handler" par mode calculent les deltas de position/rotation et activent ou désactivent les entrées selon le contexte — permettant à l'application de proposer des préréglages de navigation interchangeables calqués sur Unity, Catia, SolidWorks, Inventor, Revit et SketchUp, plus une caméra "focus" adaptative à la distance qui garde une sensation de mouvement cohérente qu'on tourne autour d'un boulon de 1mm ou d'un assemblage de 100m.`
            },
            images: [
        ...
        },
        {
            ...
            text: {
                ...
                fr: `La performance a été un autre sprint d'équipe : après que les temps de chargement ont grimpé jusqu'à 5 minutes sur les gros projets, un collègue a profilé l'application avec Superluminal et repéré les piles d'appels les plus coûteuses, et ensemble nous avons diagnostiqué et corrigé une quinzaine de problèmes — séparer les métadonnées dans leur propre fichier pour éviter des lectures complètes du projet (pris en charge par un second coéquipier), paralléliser des traitements indépendants, remplacer des appels récursifs coûteux par de l'itération, et retirer la réflexion des chemins critiques — pour une réduction de 50 à 70% des temps de chargement sur l'ensemble des projets.`
            },
    ...
    workflow: [
        ...
        },
        {
            ...
            description: {
                ...
                fr: "Une rétrospective en fin d'année 1 a pointé un vrai problème : chacun travaillait seul sur des fonctionnalités sans lien, sans moyen d'estimer la durée des tâches, si bien que les sprints devaient régulièrement être prolongés. L'année 2 a remplacé cela par une planification centrée sur les fonctionnalités et une estimation collective."
            },
            items: {
                en: [
        ...
        },
        {
            ...
            description: {
                ...
                fr: "Chaque changement partait sur une branche individuelle `feature/xxx` ou `fix/xxx`. La branche `dev` était protégée contre les push directs, si bien que l'intégration du travail passait toujours par le même point de contrôle."
            },
            items: {
                en: [
                ...
                fr: [
                    ...
                    "Des branches courtes et limitées à une seule fonctionnalité ou correction"
                ]
            }
        },
        {
            ...
            description: {
                ...
                fr: "Aucune branche n'atteignait `dev` sans une merge request approuvée par un coéquipier — généralement le directeur technique pour les changements sensibles à l'architecture, ou le collègue en charge de la partie adjacente d'une fonctionnalité partagée."
            },
            items: {
                en: [
        ...
        },
        {
            ...
            description: {
                ...
                fr: "XR Twin appliquait une politique de nommage et d'architecture C# cohérente pour qu'une base de code partagée entre plusieurs développeurs reste navigable, avec la logique réutilisable extraite sous forme de packages partagés avec d'autres produits LS Group."
            },
            items: {
                en: [
